    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text("Privacy")
                    .font(.title.bold())
                Text("Redzone does not collect and store any of your personal information. You may choose to share your current location with Redzone, which it uses to show your location on the map and provide information about outlooks covering your location. This processing is done exclusively on your device. Lock Screen & Home Screen widgets require location services, but the remaining features of Redzone will remain functional if you choose to not share your location.")

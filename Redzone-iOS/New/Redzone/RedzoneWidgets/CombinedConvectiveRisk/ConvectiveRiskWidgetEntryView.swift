    ...
    var systemSizes: some View {
        VStack {
            ...
            case .success(let success):
                HStack {
                    VStack {
                        CategoricalGaugeView(properties: .init(id: success.convective.value, title: success.convective.title, fillColor: "", strokeColor: "", expire: "", valid: "", issue: ""))
                    ...
                    if entry.day.supportsOutlookBreakdown,
                       ...
                       let discreteRisks = success.discreteRisks {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            RiskLabel(value: discreteRisks.wind?.value, sig: discreteRisks.wind?.sig ?? false, name: "Wind Risk", image: "wind")
                            RiskLabel(value: discreteRisks.hail?.value, sig: discreteRisks.hail?.sig ?? false, name: "Hail Risk", image: "cloud.hail")
                            RiskLabel(value: discreteRisks.tornado?.value, sig: discreteRisks.tornado?.sig ?? false, name: "Tornado Risk", image: "tornado")
                        }
        ...
        ZStack {
            ...
            case .accessoryCircular:
                ...
                case let .success(data):
                    CategoricalGaugeView(properties: .init(id: data.convective.value, title: data.convective.title, fillColor: "", strokeColor: "", expire: "", valid: "", issue: ""))

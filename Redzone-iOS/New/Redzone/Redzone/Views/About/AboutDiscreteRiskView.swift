...
struct AboutDiscreteRiskView: View {
    enum Risk: String {
        ...
        init?(from classification: OutlookType.Convective.Classification) {
        ...
        var sigDescription: LocalizedStringResource? {
            switch self {
            case .wind: "A significant severe region represents 10% or greater probability of 65-knot (~75 miles per hour) or greater wind gusts within 25 miles of a point. This region is represented separately from the percentage regions and may overlap with them."
            case .hail: "A significant severe region represents 10% or greater probability of 2-inch diameter hail or larger within 25 miles of a point. This region is represented separately from the percentage regions and may overlap with them."
            case .tornado: "A significant severe region represents 10% or greater probability of EF2 - EF5 tornadoes within 25 miles of a point. This region is represented separately from the percentage regions and may overlap with them."
            case .prob3: "A significant severe region represents 10% or greater probability of significant severe weather within 25 miles of a point. This region is represented separately from the percentage regions and may overlap with them."
            case .prob: nil
            }
        }
    }
